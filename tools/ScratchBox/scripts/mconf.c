...
"Overview\n"
"--------\n"
"Some features may be built directly into GoboLinux From Scratch.\n"
"Some features may be completely removed altogether.  There are also\n"
"certain parameters which are not really features, but must be\n"
...
load_config_help[] =
	"\n"
	"For various reasons, one may wish to keep several different GoboLinux\n"
	"configurations available on a single machine.\n"
	"\n"
	"If you have saved a previous configuration in a file other than the\n"
	"default one, entering the name of the file here will allow you\n"
...
save_config_help[] =
	"\n"
	"For various reasons, one may wish to keep different GoboLinux\n"
	"configurations available on a single machine.\n"
	"\n"
...
int main(int ac, char **av)
{
	...
	snprintf(menu_backtitle, 128, "GoboLinux From Scratch Configuration");
